...
for (s in 1:nrow(scenario)){
  ...
  phist[[s]] = ggplot(hr,aes(Proportion,fill=brewer.pal(n = 8, name = "YlOrRd")[4],color= brewer.pal(n = 8, name = "RdYlBu")[2] )) +
...
# ------- combine
png(paste0('figures_and_tables/output/fig3_nolabel.png'),
